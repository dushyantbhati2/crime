    ...
    <>
      <div className="sticky flex justify-between h-16 items-center z-50 top-0 w-full">
        ...
        <div className="h-16  md:w-[150px] bg-white flex items-center font-semibold overflow-hidden">
          <div className="w-[300px] md:w-[200px] md:hover:scale-105 hover:ease-out duration-100 px-3 py-2 bg-white lg:ml-8">
            <img src={logo} className="rounded-full w-[44px] md:w-[50px] h-[44px] md:h-[50px] scale-110 " />
          </div>
        </div>
        <div className="w-[calc(100%-500px)] h-16  items-center hidden md:block  md:flex  bg-white justify-center font-semibold">
          <ul className=" px-1 text-base space-x-1 gap-6  h-16 flex items-center ">
        ...
        <div className="bg-white w-[300px] h-16 md:flex items-center font-semibold hidden md:block">
