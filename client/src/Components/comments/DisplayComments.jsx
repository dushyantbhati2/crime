        ...
        <div className="w-full sm:col-span-6 justify-center my-3 p-6 overflow-y-auto no-scrollbar h-[calc(100vh-70px)]">
          <div className="w-full max-w-2xl bg-gray-900 text-white rounded-lg p-6">
            ...
            <div className="border-t border-gray-700 pt-4">
             ...
             <SingleReply reply={'How can I be part of these ?'}/>
              <SingleReply reply={'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Vel perferendis sequi animi! Porro impedit, consequuntur necessitatibus labore quo dignissimos esse.'}/>
              <SingleReply reply={'Lorem ipsum dolor sit, amet consectetur adipisicing elit. Et, obcaecati.'}/>
             </div>
            </div>
          </div>
        </div>
